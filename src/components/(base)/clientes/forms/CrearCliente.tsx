...
export function CrearCliente({ isOpen, onClose, onSuccess }: CrearClienteProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire({
        title: "¡Guardado!",
        text: "El cliente ha sido guardado exitosamente en la base de datos de Supabase.",
        icon: "success",
        timer: 2000,
      ...
      Swal.fire({
        title: "Error",
        text: "No se pudo guardar el cliente: " + err.message,
        icon: "error",
        ...getSwalThemeOpts(),
  ...
  return (
    <Modal
      title="Nuevo Cliente"
      description="Ingresa los datos para registrar un nuevo cliente en el sistema."
      isOpen={isOpen}
      onClose={handleClose}
