    ...
    <div className="flex flex-col gap-4 w-full max-w-2xl mx-auto">
      {visibleModules.map((mod, index) => {
        ...
        return (
          ...
          >
            {mod.id === "perfil" ? (
              <div className="group flex flex-col border border-red-500 dark:border-red-500/50 overflow-hidden h-full w-full rounded-2xl bg-background md:transition-colors md:duration-500 hover:border-red-600 dark:hover:border-red-500 hover:shadow-lg hover:shadow-red-600/10 dark:hover:shadow-red-500/10">
              ...
              <div
                ...
                className="group flex flex-col border border-red-500 dark:border-red-500/50 overflow-hidden h-full w-full rounded-2xl transition-colors duration-500 cursor-pointer bg-background hover:border-red-600 dark:hover:border-red-500 hover:shadow-lg hover:shadow-red-600/10 dark:hover:shadow-red-500/10"
                style={{
