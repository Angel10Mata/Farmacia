    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          onClick={onClose}
          className="fixed inset-0 z-[95] bg-black/60 backdrop-blur-sm flex items-start justify-center p-4 text-zinc-900 dark:text-zinc-100 overflow-y-auto pt-[116px] md:pt-[80px] pb-10"
        >
          <motion.div
            ...
            className="bg-background border border-border dark:border-white/10 rounded-2xl w-full max-w-md p-6 relative shadow-2xl flex flex-col gap-4 max-h-[calc(100vh-150px)] md:max-h-[calc(100vh-110px)] overflow-y-auto overflow-x-hidden custom-scrollbar"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
